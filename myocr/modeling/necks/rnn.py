...
from myocr.modeling.backbones.svtrnet import Block, ConvBNLayer
...
class EncoderWithRNN_(nn.Module):
    def __init__(self, in_channels, hidden_size):
        ...
        self.rnn1 = nn.LSTM(
            in_channels, hidden_size, bidirectional=False, batch_first=True, num_layers=2
        )
        self.rnn2 = nn.LSTM(
            in_channels, hidden_size, bidirectional=False, batch_first=True, num_layers=2
        )
...
class EncoderWithSVTR(nn.Module):
    def __init__(
        ...
        self.conv1 = ConvBNLayer(
            ...
            padding=(kernel_size[0] // 2, kernel_size[1] // 2),  # type: ignore
            act="swish",
        )
