...
from myocr.util import LabelTranslator, crop_rectangle
...
class TextRecognitionParamConverter(ParamConverter[DetectedObjects, RecognizedTexts]):
    ...
    def convert_input(self, input: DetectedObjects) -> Optional[np.ndarray]:
        ...
        for box in input.bounding_boxes:  # type: ignore
            resized_img = crop_rectangle(input.image, box)
    ...
    def convert_output(self, internal_result: Tensor | np.ndarray) -> Optional[RecognizedTexts]:
        ...
        for i in range(length):
            ...
            result.add_text(text=text, confidence=text_confidence, bounding_box=box)
        return result
